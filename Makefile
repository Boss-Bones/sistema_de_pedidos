...
CC = gcc # Compilador C
CFLAGS = -Wall -Wextra -Iinclude # Opções de compilação (-I indica onde estão os .h)
LIBS = -lncursesw # Biblioteca para interface de texto (Linux)
BUILD_DIR = build# Diretório onde serão colocados os arquivos compilados
